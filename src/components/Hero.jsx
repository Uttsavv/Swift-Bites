      ...
      <div className="max-h-[500px] relative">
        ...
        <div className="absolute w-full h-full text-gray-100 max-h-[500px] bg-black/40 flex flex-col justify-center">
          <h1 className="px-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
            The <span className="text-orange-500">Swift</span>iest
          </h1>
          <h1 className="px-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
            <span className="text-orange-500">bites</span> to you
          </h1>
        </div>
        <img
          className="w-full text-gray-100 max-h-[500px] object-cover"
